...
namespace osc {
  ...
  void SampleRenderer::render()
  {
    ...
    // -------------------------------------------------------
        ...
        filter.setImage("output", (void*)outputLayer.data, oidn::Format::Float4, outputLayer.width, outputLayer.height, 0, outputLayer.pixelStrideInBytes, outputLayer.rowStrideInBytes);
        filter.set("hdr", true);
        filter.commit();
        filter.execute();
